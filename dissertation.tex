...
\input{Dissertation/setup}      % Упрощенные настройки шаблона
...
\setcounter{totalchapter}{\value{chapter}} % Подсчет количества глав
...
\setcounter{totalappendix}{\value{chapter}} % Подсчет количества приложений
