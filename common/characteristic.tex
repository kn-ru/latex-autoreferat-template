...
автоматически пропадет раздел <<Список литературы>>). Внимание! Ссылки
...
счетчику \verb!\setcounter{usefootcite}{1}!.
...
{%%% Реализация пакетом biblatex через движок biber
    ...
    \begin{refsection}[bl-author, bl-registered]
        ...
        \nocite{Rusakov2025bayesmodel}%vak
        \nocite{Rusakov2025bayesclass}%vak
        \nocite{Rusakov2024mlsd}%conf
        \nocite{prog_reid_bayes}%program
        \nocite{prog_detect_small}%program
    \end{refsection}%
        %
