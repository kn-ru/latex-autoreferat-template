...
Организация:    Институт проблем управления им. В.А. Трапезникова РАН (ИПУ РАН)
Год:            2026
...
Ссылки:
    [1] Русаков К.Д. Байесовская модель объединения признаковых
        представлений в задаче реидентификации личности //
        Управление большими системами. 2025. Вып. 115. С. 183–202.
    [2] Русаков К.Д. Байесовский алгоритм классификации в задаче
        реидентификации личности // Известия ЮЗГУ. 2025. Т.29, №3.
================================================================================
"""
